...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased background-img">
        ...
        <h2 class="text-center margin-top register-style">Register</h2>
            <form id="myForm" method="POST" action="/register">
                {{ csrf_field() }}
                <div class="form-group input-style">
                    <input inputmode="email" type="email" class="form-control" id="email" name="email" placeholder="Email to Register">
                </div>
